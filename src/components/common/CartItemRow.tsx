          ...
          <div className="card-body">
            ...
            <div className="d-flex align-items-center justify-content-between">
              <div className="d-flex align-items-center">
                ...
                <button className="btn btn-primary btn-sm px-3" onClick={() => decreaseQuantity(item.id)}>-</button>
                <span className="mx-3" data-testid="quantity">{item.quantity}</span>
                <button className="btn btn-primary btn-sm px-3" onClick={() => increaseQuantity(item.id)}>+</button>
              </div>
